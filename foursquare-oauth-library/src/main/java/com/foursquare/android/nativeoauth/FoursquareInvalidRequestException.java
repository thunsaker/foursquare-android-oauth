...
public class FoursquareInvalidRequestException extends Exception {
    ...
    public FoursquareInvalidRequestException(String detailMessage) {
        super(detailMessage);
    }

    public FoursquareInvalidRequestException(Throwable throwable) {
        super(throwable);
    }

    public FoursquareInvalidRequestException(String detailMessage, Throwable throwable) {
